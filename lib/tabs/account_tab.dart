...
class _AccountTabState extends State<AccountTab> {
  ...
  Widget _customSelectableWidgetBuilder(
      {required String title, required String placeholderText}) {
    return Column(
      children: [
        GestureDetector(
          onTap: () {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              //   onTapFunc: () async {
              //     await Share.share(
              //         'Download this Amazing application: https://play.google.com/store/apps/details?id=com.olxagri.app'); // Put Your App Url here.
              //   },
              //   trailing: Icon(
              //     Icons.arrow_right,
              //     color: Colors.grey[800],
